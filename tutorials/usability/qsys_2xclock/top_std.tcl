...
set_instance_parameter_value iopll_0 {gui_clock_name_string0} {outclk}
set_instance_parameter_value iopll_0 {gui_clock_name_string1} {outclk2x}
...
set_instance_parameter_value iopll_0 {gui_output_clock_frequency1} {200.0}
...
add_instance synchronizer_0 synchronizer 1.0

# exported interfaces
add_interface a conduit end
set_interface_property a EXPORT_OF foo_0.a
add_interface b conduit end
set_interface_property b EXPORT_OF foo_0.b
add_interface c conduit end
set_interface_property c EXPORT_OF foo_0.c
add_interface call conduit end
set_interface_property call EXPORT_OF foo_0.call
add_interface clk clock sink
set_interface_property clk EXPORT_OF clk_0.clk_in
add_interface d conduit end
set_interface_property d EXPORT_OF foo_0.d
add_interface reset reset sink
set_interface_property reset EXPORT_OF clk_0.clk_in_reset
add_interface return conduit end
set_interface_property return EXPORT_OF foo_0.return
add_interface returndata conduit end
set_interface_property returndata EXPORT_OF foo_0.returndata

# connections and connection parameters
add_connection clk_0.clk iopll_0.refclk

add_connection clk_0.clk_reset iopll_0.reset

add_connection clk_0.clk_reset synchronizer_0.resetn

add_connection iopll_0.outclk0 foo_0.clock

add_connection iopll_0.outclk0 synchronizer_0.clock

add_connection iopll_0.outclk1 foo_0.clock2x

add_connection synchronizer_0.resetn_out foo_0.reset
